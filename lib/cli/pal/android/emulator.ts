...
export function emulator (args: string[], env: Record<string, string> = {}): { result: Promise<string>, proc: any } {
  ...
  return makeFork(`${ANDROID_SDK_ROOT}/emulator/emulator`)(args, env)
}
